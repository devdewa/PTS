...
<head>
    ...
    <title>Adityawarman Dewa Putra - PTS Ganjil</title>
...
<body class="m-0 p-0">
    ...
    <div class="navbar mb-2 shadow-sm d-bg-gradient text-neutral-content">
        ...
        <div class="hidden px-2 mx-2 navbar-center lg:flex">
            <div class="flex items-stretch">
                <label for="my-modal-2" class="btn btn-ghost btn-sm rounded-btn tracking-widest">Post +</label> 
            </div>
        </div> 
    ...
    <!-- Content -->
    <div class="container min-h-0 mb-44 2xl:mb-96 m-auto bg-white pt-12 px-4">
        <?php
            include 'koneksi.php';
            $no= 1;
            $data1 = mysqli_query($koneksi, "SELECT * FROM hasil ORDER BY id DESC LIMIT 1");
            $data2 = mysqli_query($koneksi, "SELECT * FROM hasil");
            while($d = mysqli_fetch_array($data1)){
        ?>
            <div class="shadow stats mb-8">
            <div class="stat">
                <div class="stat-title">Total User</div> 
                <div class="stat-value text-info"><?php echo $d['id']; ?></div> 
            </div>
            </div>
        <?php
            }
        ?>
        <div class="text-sm breadcrumbs mb-6 px-2">
            <ul>
                <li>
                    <a>
        ...
        <div class="overflow-x-auto">
            <table class="table w-full">
                ...
                <tr class="hover">
                    <th><?php echo $no++; ?></th>
                    <td><a href="profile.php?id=<?php echo $d['id']; ?>"><?php echo $d['nama']; ?></a></td> 
    ...
    <div class="modal">
        <div class="modal-box">
            <form action="proses-create.php" method="POST" enctype="multipart/form-data">
                ...
                <!-- Foto -->
                Preview: <img id="thumb" alt="image" src="<?php echo "asset/image/post-img/".$d['image']; ?>" width="100" height="100" />
                ...
                <div class="form-control mt-4">
                    ...
                    <input type="text" placeholder="Nama" id="nama" name="nama" class="input input-primary input-bordered" required>
                </div>
                ...
                <div class="form-control mt-4">
                    ...
                    <input type="number" placeholder="Nilai" id="nilai" name="nilai" class="input input-primary input-bordered" required>
                </div>

                <div class="modal-action">
                    <button type="submit" class="btn btn-primary">Accept</button>
                    <label for="my-modal-2" class="btn btn-warning">Close</label>
                </div>

...
<head>
    ...
    ?>
    <title>Profile | <?php echo $d['nama']; ?></title>
    <?php
        }
    ?>
...
<body class="m-0 p-0">
    ...
    <div class="container my-40 m-auto bg-white px-4">
        ...
        <div class="flex items-center w-full px-4 py-10 bg-cover card bg-base-200" style="background-image: url('asset/image/bg-profile.png');" id="bg-profile">
            <div class="card glass lg:card-side text-neutral-content">
               
                <img src="<?php echo "asset/image/post-img/".$d['image']; ?>" alt="Profile" id="profile-img" class="rounded-lg shadow-lg">
           
                <div class="max-w-md card-body">
                    <h2 class="card-title text-gray-700 tracking-wider"><?php echo $d['nama']; ?></h2> 
                    <p class="text-gray-700">Nilai: <?php echo $d['nilai']; ?></p> 
                    <div class="card-actions mt-6" title="Edit">
                        <a href="edit.php?id=<?php echo $d['id']; ?>" class="btn bg-warning border-none"><img src="asset/image/pen.svg" alt="Pen" class="w-4/12 h-4/12"></a>
                    </div>
                    <div class="card-actions" title="Hapus">
                        <a href="delete.php?id=<?php echo $d['id']; ?>" class="btn bg-error border-none"><img src="asset/image/trash.svg" alt="Trash" class="w-4/12 h-4/12"></a>
                    </div>
                </div>
            </div>
        </div>
